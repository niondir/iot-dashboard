...
/***/ function(module, exports, __webpack_require__) {
	...
	var _persistence = __webpack_require__(220);
	...
	var _widgets = __webpack_require__(185);

	var Widgets = _interopRequireWildcard(_widgets);

	var _exampleCounter = __webpack_require__(234);

	var Counter = _interopRequireWildcard(_exampleCounter);

	var _widgetTypes = __webpack_require__(235);

	var WidgetTypes = _interopRequireWildcard(_widgetTypes);

	var _widgetConfig = __webpack_require__(187);

	var WidgetConfig = _interopRequireWildcard(_widgetConfig);

	var _layouts = __webpack_require__(216);

	var Layouts = _interopRequireWildcard(_layouts);

	var _actionNames = __webpack_require__(189);

	var _timeWidget = __webpack_require__(236);

	var TimeWidget = _interopRequireWildcard(_timeWidget);

	var _textWidget = __webpack_require__(237);

	var TextWidget = _interopRequireWildcard(_textWidget);

	var _chartWidget = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _layouts = __webpack_require__(215);

	var Layouts = _interopRequireWildcard(_layouts);

	var _import = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactGridLayout = __webpack_require__(192);
	    ...
	    _createClass(WidgetGrid, [{
	        ...
	        value: function render() {
	            ...
	            var widgets = widgetData.map(function (data) {
	                return Widgets.WidgetFrame(data);
	            });
	            return React.createElement(
	                ResponsiveGrid,
	                (_React$createElement = { className: 'column', cols: 12, rowHeight: 200,
	                    breakpoints: { lg: 1200, md: 996, sm: 768, xs: 480, xxs: 0 }
	                }, _defineProperty(_React$createElement, 'cols', { lg: 6, md: 6, sm: 6, xs: 4, xxs: 2 }), _defineProperty(_React$createElement, 'draggableCancel', '.no-drag'), _defineProperty(_React$createElement, 'draggableHandle', '.drag'), _defineProperty(_React$createElement, 'onLayoutChange', this.onLayoutChange.bind(this)), _React$createElement),
	                widgets
	            );
	        }
	    }]);
	...
	var WidgetGridContainer = (0, _reactRedux.connect)(function (state) {
	    return {
	...
	exports.WidgetGrid = WidgetGridContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ConfigWidgetButton = exports.DeleteWidgetButton = exports.WidgetFrame = exports.initialWidgets = undefined;
	...
	var _collection = __webpack_require__(190);
	...
	var widgetsCrudReducer = (0, _reducer.genCrudReducer)([_actionNames.ADD_WIDGET, _actionNames.UPDATE_WIDGET_PROPS, _actionNames.DELETE_WIDGET], widget, initialWidgets);
	function widgets() {
	...
	function register(module) {
	    ...
	    widgets[module.TYPE_INFO.type] = _extends({}, module.TYPE_INFO, {
	...
	var WidgetFrame = exports.WidgetFrame = function WidgetFrame(widgetState) {
	    var widget = getWidget(widgetState.type);
	    ...
	    return React.createElement(
	        ...
	        React.createElement(
	            ...
	            React.createElement(widget.widget, _extends({}, widgetState.props, { _state: widgetState }))
	        )
	    );
	};
	...
	var DeleteWidgetButton = exports.DeleteWidgetButton = (0, _reactRedux.connect)(function (state) {
	    return {};
	}, function (dispatch) {
	    return {
	...
	var ConfigWidgetButton = exports.ConfigWidgetButton = (0, _reactRedux.connect)(function (state) {
	    return {};
	}, function (dispatch) {
	    return {
	        onClick: function onClick(widgetState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createWidget(type) {
	    var widget = Widgets.getWidget(type);
	    return function (dispatch, getState) {
	...
	var ConfigDialog = function (_React$Component) {
	    ...
	    _createClass(ConfigDialog, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var widget = Widgets.getWidget(this.props.widgetType);
...
/***/ function(module, exports) {
	...
	function genCrudReducer(actionNames, elementReducer) {
	    ...
	    var idProperty = arguments.length <= 3 || arguments[3] === undefined ? 'id' : arguments[3];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uiElements = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ui = _interopRequireWildcard(_uiElements);
	    ...
	    _createClass(MyLayoutItem, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('i', { className: 'right floated remove huge icon', style: { zIndex: 9000 }, onClick: function onClick(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var layoutCrudReducer = (0, _reducer.genCrudReducer)([_actionNames.ADD_LAYOUT, _actionNames.UPDATE_LAYOUT, _actionNames.DELETE_LAYOUT], layout, initialLayouts);
	function layouts() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _import = __webpack_require__(218);
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                { className: 'item', onClick: function onClick() {
	                        return _modal2.default.showModal("dashboard-import-export");
	                    } },
...
/***/ function(module, exports, __webpack_require__) {
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						'a',
						{ onClick: function onClick() {
								return _this2.props.clickLink(3);
							} },
						'Click me'
					),
					': ',
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
		return {
			clickLink: function clickLink(amount) {
				dispatch(incCounter(amount));
			}
		};
	};

	var CounterApp = exports.CounterApp = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Counter);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _c = __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (window) {
	    ...
	    function ChartInternal(api) {
	        var $$ = this;
	        $$.d3 = window.d3 ? window.d3 :  true ? __webpack_require__(239) : undefined;
	        $$.api = api;
	    ...
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(239)], __WEBPACK_AMD_DEFINE_FACTORY__ = (c3), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
