...
/***/ function(module, exports, __webpack_require__) {
	...
	var FrameDatasourceInstance = (function () {
	    function FrameDatasourceInstance(url) {
	        var _this = this;
	        this.data = [];
	        this.fetchReplaceData = false;
	        this.scheduler = new datasourceScheduler_1.DatasourceScheduler(this);
	    ...
	    Object.defineProperty(FrameDatasourceInstance.prototype, "id", {
	        get: function () {
	    ...
	    Object.defineProperty(FrameDatasourceInstance.prototype, "type", {
	        get: function () {
	    ...
	    FrameDatasourceInstance.prototype.initialSetTypeInfo = function (typeInfo) {
	        if (this.typeInfo !== undefined) {
	            throw new Error("Can not change typeInfo after it was set");
	        }
	        this.typeInfo = typeInfo;
	    };
	    FrameDatasourceInstance.prototype.initialSetDatasourceClass = function (datasourceClass) {
	        if (this.datasourceClass !== undefined) {
	            throw new Error("Can not change datasourceClass after it was set");
	        }
	        this.datasourceClass = datasourceClass;
	    };
	    FrameDatasourceInstance.prototype.initializePluginInstance = function () {
	        var _this = this;
	        var props = {
	            state: this.dsState,
	    ...
	    FrameDatasourceInstance.prototype.fetchData = function (resolve, reject) {
	    ...
	    FrameDatasourceInstance.prototype.fetchedDatasourceData = function (data) {
	        if (!_.isArray(data)) {
	            data = [data];
	        }
	        ...
	        var maxValues = Math.max(1, this.dsState.settings.maxValues);
	        data = _.takeRight(data, maxValues);
	        this.data = data;
	        this.sendDataToApp();
	    };
	    FrameDatasourceInstance.prototype.sendDataToApp = function () {
	        this.sendMessage({
	            type: pluginTypes_1.MESSAGE_DATA,
	            payload: this.data
	        });
	    };
	    FrameDatasourceInstance.prototype.setFetchInterval = function (intervalMs) {
	        this.scheduler.fetchInterval = intervalMs;
	    };
	    FrameDatasourceInstance.prototype.setFetchReplaceData = function (replace) {
	        this.fetchReplaceData = replace;
	    };
	    FrameDatasourceInstance.prototype.updateInstanceWithState = function (newState) {
	        var oldProps = this.dsInstance.props;
	        var newProps = _.assign({}, oldProps, { state: newState });
	    ...
	    FrameDatasourceInstance.prototype.sendMessage = function (msg) {
	    ...
	    FrameDatasourceInstance.prototype.datasourceWillReceiveProps = function (newProps) {
	        if (newProps.state.settings !== this.dsState.settings) {
	    ...
	    FrameDatasourceInstance.prototype.loadPluginScriptDependencies = function (typeInfo, url) {
	    ...
	    return FrameDatasourceInstance;
	}());
...
/******/ });
//# sourceMappingURL=datasource.bundle.js.map