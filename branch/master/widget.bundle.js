...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(k,n){ true?module.exports=n(__webpack_require__(64),__webpack_require__(65),__webpack_require__(66)):"function"===typeof define&&define.amd?define(["./punycode","./IPv6","./SecondLevelDomains"],n):k.URI=n(k.punycode,k.IPv6,k.SecondLevelDomains,k)})(this,function(k,n,g,f){function d(a,b){var c=1<=arguments.length,l=2<=arguments.length;if(!(this instanceof d))return c?l?new d(a,b):new d(a):new d;if(void 0===a){if(c)throw new TypeError("undefined is not a valid argument for URI");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var framePluginInstance_1 = __webpack_require__(121);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FramePluginInstance = (function () {
	    function FramePluginInstance(url, appElement) {
	        var _this = this;
	        ...
	        scriptLoader_1.default.loadScript([url])
	            ...
	            .then(function () {
	            _this.sendMessage({ type: "init" });
	        })
	            .catch(function (e) {
	            console.error("Failed to load widget plugin from URL", url, e);
	        });
	    }
	    FramePluginInstance.prototype.sendMessage = function (msg) {
	    ...
	    FramePluginInstance.prototype.loadPluginScriptDependencies = function (typeInfo, url) {
	    ...
	    return FramePluginInstance;
	}());
	exports.FramePluginInstance = FramePluginInstance;
