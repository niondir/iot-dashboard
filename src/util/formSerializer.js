...
export default function serializeForm(form, options = defaultOptions) {
...
function parse_keys(string) {
    const keys = [];
    const prefix = /^([^\[\]]*)/;
    const children = brackets;  // Was new RegExp(brackets) - in case it breaks now
